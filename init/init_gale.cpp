...
void vendor_load_properties() {
    ...
    if (sku == "c3un") {
        model_property_override("gust", "Redmi 13C");
    } else if (sku == "c3upg") {
        model_property_override("gust", "Poco C65");
    } else if (sku == "c3upin") {
        model_property_override("gale", "Poco C65");
    } else {
        model_property_override("gale", "Redmi 13C");
    }
}
